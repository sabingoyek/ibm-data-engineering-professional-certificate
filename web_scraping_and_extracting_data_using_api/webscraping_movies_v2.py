...
db_name = 'Movie.db'
table_name = 'Top_50_v2'
csv_path = 'top_50_films_v2.csv'
...
data_dict = {"Film": [], "Year": [], "Rotten Tomatoes' Top 100": []}
...
for row in rows:
    if count < 50:
        ...
        if len(col) != 0:
            ...
            data_dict["Rotten Tomatoes' Top 100"].append(str(col[3].contents[0]))
            count += 1
    else:
        break
